defmodule Upstream.B2.Upload.File do
  ...
  def header(file_data) do
    preset_name = Map.get(file_data.file_info, :preset_name)
    uploader = Map.get(file_data.file_info, :uploader, "upstream")
    ...
    [
      ...
      {"X-Bz-Info-preset_name", preset_name},
      {"X-Bz-Info-uploader", uploader}
    ]
  end
